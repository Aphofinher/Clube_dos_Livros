...
<form action="/create-usuario" method="post" id="formulario-principal">
    <section class="main">
        ...
        <div class="forms">
            ...
            <input type="text" placeholder="Selecione a sua categoria:" id="categoria-usuario" name="categoria-usuario">
            <input type="text" placeholder="Livros:" id="usuario-livro" name="usuario-livro">
